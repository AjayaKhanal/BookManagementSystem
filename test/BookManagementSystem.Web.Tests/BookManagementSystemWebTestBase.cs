...
{
    public abstract class BookManagementSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BookManagementSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BookManagementSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BookManagementSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BookManagementSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BookManagementSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BookManagementSystemDbContext, Task<T>> func)
        {
            T result;
